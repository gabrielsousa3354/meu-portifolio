    ...
    <footer>
      ...
      <div className="footer-container">
        ...
        <div className="footer-column">
          ...
          />
          <p><strong>CNPJ:</strong> 57.524.519/0001-96</p>
          <p><strong>Endereço:</strong> Avenida Paulista, 1636, CJ 4 PAV. 15, SALA 1504,<br></br> Paulista Corporate, CEP 01310-200. </p>
        </div>

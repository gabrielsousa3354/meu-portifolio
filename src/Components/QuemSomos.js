...
const QuemSomos = () => {
  return (
    <div className="quem-somos-container">
      ...
      {/* Div azul com "QUEM SOMOS" */}
      <div className="header-section">
        <h1 className="header-title">QUEM SOMOS</h1>
      </div>

      {/* Conteúdo principal com título, texto e imagem */}
      ...
      <div className="cards-container">
        <div className="card">
          ...
          <p className="card-text"> Santander, Itaú, Bradesco, Banco do Brasil, Caixa Econômica Federal, BRB, Inter.</p>
        </div>
        <div className="card">
          <h3 className="card-title">Financiamento descomplicado</h3>
          <p className="card-text">Você não precisa do stress para financiar seu imóvel, nós fazemos tudo por você, sem custo e sem sair de casa. </p>
        </div>
        <div className="card">
          <h3 className="card-title">Suporte exclusivo</h3>
          <p className="card-text">Estamos 24h disponíveis para tirar dúvidas, com tratamento humanizado e personalizado</p>
        </div>
      </div>
    </div>
  );
